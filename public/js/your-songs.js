function onloadYourSong() {
    addHTMLYourSong();
    elementBindingYourSong();
    addEventYourSong();
}

function addHTMLYourSong() {
    ...
    document.getElementById("a-songs-your-songs").classList.add("active");
}

function elementBindingYourSong() {

}

function addEventYourSong() {

}

async function fetchYourSongs () {
    let tbody = document.getElementById("tbody");
    const response = await fetch(`${BE_SERVER_PORT}/your-song`, defaultFetchOpts);
